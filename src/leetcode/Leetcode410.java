...
public class Leetcode410 {
     ...
     * algorithm to minimize the largest sum among these m subarrays. Note:
     * Given m satisfies the following constraint: 1 ≤ m ≤ length(nums) ≤
     * 14,000. 
     * 
     * Input: nums = [7,2,5,10,8] m = 2 Output: 18 Explanation: There
     * are four ways to split nums into two subarrays. The best way is to split
     ...
     * 每次都假定mid是正确的返回值，看看能否推出矛盾，即如果把nums分成m份,每一份都的和都大于mid，那肯定说明这个mid太小了。需要增加（low = mid+1）（折半查找）
